...
-- Ped Configuration
Config.Ped = {
    location = vector4(215.5753, -23.9149, 69.7021, 158.2341), -- Change this vector to your desired location
    model = "s_m_y_chef_01", -- Default ped model, can be changed
}

-- Blip Configuration (No separate location, uses ped location)
Config.Blip = {
    sprite = 488, -- Blip icon (pizza slice for food-related jobs)
    color = 1, -- Default color
    size = 0.8, -- Default size
    label = "Pizza Delivery", -- Label for the blip
}

-- Target Settings for the Ped
Config.TargetSettings = {
    label = "Talk to Chef", -- Default label for the target interaction
    distance = 2.5, -- Default distance for targeting the ped
    size = 1.0, -- Default size of the targetable area
}

-- Delivery Settings
Config.Deliveries = {
    vehicle = 'panto', -- Vehicle model for deliveries
    spawnLocation = vector4(220.0990, -32.8182, 69.7189, 68.5840), -- Vehicle spawn location
